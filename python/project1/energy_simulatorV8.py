...
# CONFIGURATION
# --------------------
API_KEY = '1310cc9029637831bbb879313d029008'  # Replace with your actual OpenWeatherMap API key
...
def get_solar_production(hour, solar_capacity):
    if 6 <= hour <= 18:
        sunlight_curve = sin((pi / 12) * (hour - 6))  # Peaks at 12:00
...
for h in range(SIM_HOURS):
    ...
    if net1 > 0:
        ...
        if u1['battery'] > 0.1 * u1['battery_capacity']:  # Lower threshold for selling
...
csv_filename = "simulation_output.csv"
