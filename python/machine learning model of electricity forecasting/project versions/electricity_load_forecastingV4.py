...
# Train: 2009–2021  |  Test: 2022–2024
...
# ── SECTION 8: Visualization (each plot saved separately) ────
PLOT_PERIODS = 14 * 48  # last 14 days of test data
...
ax.plot(plot_dates, plot_actual, label="Actual ND",         color="#2C3E50", lw=1.5, zorder=3)
...
ax.set_title("Actual vs Predicted National Demand (last 14 days of test set)", fontsize=13, fontweight="bold")
...
bars = ax.barh(top_n.index, top_n.values, color=colors, edgecolor="white")
ax.bar_label(bars, fmt="%.3f", padding=3, fontsize=10)
ax.set_title("Random Forest — Top 12 Feature Importances", fontsize=13, fontweight="bold")
...
metrics = ["MAE (MW)", "RMSE (MW)", "MAPE×10 (%)"]
...
bars1 = ax.bar(x - w/2, lr_vals, w, label="Linear Regression", color="#E74C3C", alpha=0.85)
bars2 = ax.bar(x + w/2, rf_vals, w, label="Random Forest",     color="#27AE60", alpha=0.85)
