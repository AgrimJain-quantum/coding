...
CSV_PATH = r"C:\Users\Agrim Jain\Desktop\Coding\coding\python\machine learning model of electricity forecasting\datasets\load_forecasting_dataset_corrected.csv"   # ← your file path
